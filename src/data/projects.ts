...
export interface Project {
  ...
  features: string[];
  outcome: string;
  color: string; // Specific distinct accent color
  prototypeUrl?: string;
  behanceUrl?: string;
  persona: Persona;
  process: ProcessStep[];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    overview:
      "My Vetry Tamil Nadu is a web application for Tamil Nadu citizens, local administrators, and community members. It simplifies service discovery, eligibility checks, constituency intelligence, issue tracking, and public engagement -  all with full Tamil/English localization.",
    problem:
    ...
    outcome:
      "A polished, scalable prototype for a citizen-facing government service portal -  bilingual, service-centric, and data-rich -  demonstrating strong potential as a real-world public service platform.",
    color: "#0ea5e9", // Blue for Govt/Civic
    ...
    persona: {
      ...
      goals: [
        "Apply for government schemes in Tamil",
        "Know which documents are needed before visiting an office",
      ...
      frustrations: [
        ...
        "Complaints disappear once submitted -  no tracking",
      ],
    },
    process: defaultProcess,
  },
  {
    ...
    persona: {
      ...
      goals: [
        "Send birthday and reminder messages at the right moment",
        "Message international teammates during their working hours",
        "Draft messages late at night without waking people up",
      ],
      frustrations: [
        "Sends messages at 1 AM by accident",
        "Forgets to send follow-ups the next morning",
  ...
  },
  {
    ...
    overview:
      "Curl Diary combines a lightweight daily log, a product library and a progress timeline. It personalises recommendations based on the user's curl type and porosity, and celebrates small wins along a long journey.",
    problem:
      "People transitioning to natural hair juggle scattered advice, expensive product experiments and slow visible progress. There's no calm, personal space to track what works for their specific hair.",
    goals: [
    ...
    outcome:
      "A warm, calm mobile app that treats a slow journey with care. Prototype tested with 4 target users -  all reported the daily log felt lighter than existing tools they'd tried.",
    color: "#f43f5e", // Rose for Wellness/Beauty
    behanceUrl: "https://www.behance.net/saravanan_design",
    persona: {
      name: "Divya K.",
      age: 26,
  ...
  },
  {
    ...
    problem:
      "Citizens raise complaints across scattered channels -  helplines, Twitter, WhatsApp groups -  and never hear back. There's no shared record and no accountability.",
    goals: [
    ...
    outcome:
      "A trust-first prototype that treats complaints as living records, not black holes -  validated with 6 residents who preferred it over their current WhatsApp-based reporting.",
    color: "#14b8a6", // Teal for Civic App
    behanceUrl: "https://www.behance.net/saravanan_design",
    persona: {
      name: "Ramesh V.",
      age: 38,
      ...
      goals: [
        ...
        "Rally neighbours around real problems",
  ...
  },
  {
    ...
    color: "#f97316", // Orange for Healthcare App
    behanceUrl: "https://www.behance.net/saravanan_design",
    persona: {
      name: "Lakshmi S.",
      age: 34,
